...
function! g:embrace#bufsurf#BufSurfDelete(bufnr, wipeout) abort
    ...
    if a:wipeout
        ...
        for l:tab_info in gettabinfo()
            for win_idx in l:tab_info.windows
                let history = gettabwinvar(l:tab_info.tabnr, win_idx, 'history')
                ...
                let history_index = gettabwinvar(l:tab_info.tabnr, win_idx, 'history_index')
                ...
                call settabwinvar(l:tab_info.tabnr, win_idx, 'history', history)
                ...
                if history_index >= len(history)
                    ...
                    call settabwinvar(l:tab_info.tabnr, win_idx, 'history_index', history_index)
                endif
            endfor
        endfor
    endif
